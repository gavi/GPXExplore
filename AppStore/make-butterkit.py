...
PRESETS = {
    ...
    "mac": {
        ...
        "y": -8.91,
        "spacing": 3.8,
        "model": {"assetName": "MacbookPro16", "instanceLabel": "MacBook Pro 16″",
                  "rotationEuler": [0.2799508, 0, 0], "scale": [4.6430507, 4.6430507, 4.6430507],
                  "positionOffset": [0, -0.224, 0], "deviceStyle": "uiOnly"},
        "hero_model": {"assetName": "MacbookPro16", "instanceLabel": "MacBook Pro 16″",
                       "rotationEuler": [0.2799508, 0, 0], "scale": [4.6430507, 4.6430507, 4.6430507],
                       "positionOffset": [0, -0.224, 0], "deviceStyle": "uiOnly"},
        "caption": {"sizePt": 48, "paddingTop": 3.373039448669212, "paddingSides": 0,
                    "fontFamily": "System Default", "role": "Text1"},
        "hero_title": {"sizePt": 52, "paddingTop": 2.6, "paddingSides": 0,
                       "fontFamily": "Avenir Next", "role": "Title"},
        "hero_subtitle": {"sizePt": 30, "paddingTop": 6.4, "paddingSides": 0,
                          "fontFamily": "System Default", "role": "SubTitle"},
    },
}
